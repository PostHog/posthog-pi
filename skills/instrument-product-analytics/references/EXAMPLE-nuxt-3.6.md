        ...
        <template v-else>
            ...
            <form @submit.prevent="handleSubmit" class="form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" v-model="password" placeholder="Enter any password" />
                </div>
    ...
    <div class="container">
        ...
        <div style="margin-top: 2rem">
            ...
            <template v-if="user">
                ...
                <p v-else-if="user.burritoConsiderations < 5">You're getting the hang of burrito consideration!</p>
                <p v-else-if="user.burritoConsiderations < 10">You're becoming a burrito consideration expert!</p>
