...
```html
{% extends "base.html" %} {% block title %}Burrito - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
...
```html
{% extends "base.html" %} {% block title %}Dashboard - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
    <h1>Dashboard</h1>
...
```html
{% extends "base.html" %} {% block title %}Page Not Found - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
...
```html
{% extends "base.html" %} {% block title %}Server Error - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
...
```html
{% extends "base.html" %} {% block title %}Login - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
...
```html
{% extends "base.html" %} {% block title %}Profile - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
    <h1>Your Profile</h1>
...
```html
{% extends "base.html" %} {% block title %}Sign Up - PostHog FastAPI Example{% endblock %} {% block content %}
<div class="card">
    ...
    <p style="margin-top: 16px; font-size: 14px; color: #666;">Already have an account? <a href="/">Login here</a></p>
</div>
