...
1.  1
    ...
    **Event name**: `$ai_generation`
    ...
    | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    | $ai_trace_id            | The trace ID (a UUID to group AI events) like conversation*idMust contain only letters, numbers, and special characters: -, *, ~, ., @, (, ), !, ', :, \|Example: d9222e05-8708-41b8-98ea-d4a21849e761                                      |
