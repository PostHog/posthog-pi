...
```html
{% extends "base.html" %} {% block title %}Burrito - PostHog Flask Example{% endblock %} {% block content %}
<div class="card">
...
```html
{% extends "base.html" %} {% block title %}Dashboard - PostHog Flask Example{% endblock %} {% block content %}
<div class="card">
    <h1>Dashboard</h1>
...
```html
{% extends "base.html" %} {% block title %}404 - Page Not Found{% endblock %} {% block content %}
<div class="card" style="text-align: center; padding: 60px 20px;">
    ...
    <div style="background: #fef3c7; border: 1px solid #fbbf24; border-radius: 8px; padding: 15px; margin: 30px 0;">
        ...
        <code style="background: #fff; padding: 5px 10px; border-radius: 4px; font-family: monospace; color: #1e40af;"
            >{{ error_id }}</code
        >
...
<div class="card" style="text-align: center; padding: 60px 20px;">
    ...
    <div
        style="background: #fee2e2; border: 1px solid #dc2626; border-radius: 8px; padding: 15px; margin: 30px 0; text-align: left;"
    >
        <p style="color: #7f1d1d; margin-bottom: 5px; font-weight: 600;">Debug Information:</p>
        <code
            style="background: #fff; padding: 10px; border-radius: 4px; font-family: monospace; color: #dc2626; display: block; overflow-x: auto;"
            >{{ error }}</code
        >
    </div>
    {% endif %}
...
```html
{% extends "base.html" %} {% block title %}Login - PostHog Flask Example{% endblock %} {% block content %}
<div class="card">
    ...
    <p style="font-size: 14px; color: #666;"><strong>Tip:</strong> Default credentials are admin@example.com/admin</p>
</div>
...
```html
{% extends "base.html" %} {% block title %}Profile - PostHog Flask Example{% endblock %} {% block content %}
<div class="card">
    <h1>Your Profile</h1>
...
<div class="card">
    ...
    <div style="margin: 20px 0;">
        <button class="danger" onclick="triggerError('value')">Trigger ValueError</button>
        <button class="danger" onclick="triggerError('key')">Trigger KeyError</button>
        <button class="danger" onclick="triggerError('generic')">Trigger Generic Error</button>
    </div>
...
```html
{% extends "base.html" %} {% block title %}Sign Up - PostHog Flask Example{% endblock %} {% block content %}
<div class="card">
