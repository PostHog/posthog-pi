...
- **Source Maps**: Automatic source map uploads when _building for production_
...
<template>
    <div class="container">
        ...
        <div style="text-align: center">
            <button @click="handleConsideration" class="btn-burrito">I have considered the burrito potential</button>
...
<template>
    <div class="container">
        ...
        <div style="margin-top: 2rem">
            ...
            <p v-else-if="user && user.burritoConsiderations < 5">You're getting the hang of burrito consideration!</p>
            <p v-else-if="user && user.burritoConsiderations < 10">You're becoming a burrito consideration expert!</p>
